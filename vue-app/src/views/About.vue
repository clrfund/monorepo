<template>
  <div class="about">
    ...
    <p>See the <a href="https://github.com/clrfund/constitution" target=_blank>Clr.fund Constitution</a> for more detail on Clr.fund’s goals and values.</p>

    <h2>How does it work?</h2>
    <p>The clr.fund protocol uses the <a href="https://blogchains.org/wp-content/uploads/sites/4/2019/04/SSRN-id3243656.pdf" target=_blank>Constrained Liberal Radicalism (CLR)</a> algorithm, commonly called quadratic funding (QF), to facilitate monetary contributions from members of the Ethereum Community towards builders of Ethereum public goods.
    ...
    <p>Under the hood, clr.fund uses zero-knowledge proofs (zk-snarks), courtesy of the <a href="https://github.com/appliedzkp/maci" target=_blank>Minimal Anti-collusion Infrastructure (MACI)</a>, to keep individual contributions private and limit effectiveness of collusion and bribery.</p>

    <p>Recipients are curated by our <a href="https://curate.kleros.io/tcr/0x2E3B10aBf091cdc53cC892A50daBDb432e220398" target=_blank>Kleros TCR.</a></p>

    <p>Sybil resistance is manual for the first round (handled by a multisig of clr.fund contributors), but future iterations will rely on  <a href="https://brightID.org" targe=_blank>BrightID</a> for more permissionless and trustless Sybil resistance.</p>
