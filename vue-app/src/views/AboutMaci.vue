<template>
  <div class="about">
    ...
    <p>
      En las elecciones tradicionales, los votos son secretos, lo que dificulta la manipulación
      de los votantes. ¡Pero no hay secretos en los blockchain como Ethereum! En la mayoría de
    ...
    <ul>
      <li>
        Ethereum tiene una gran combinación de bajos costos de infraestructura y alta seguridad
        (es decir, difícil de piratear) en comparación con otras soluciones de votación electrónica.
      </li>
      <li>
    ...
    <p>
      Si bien alejarse de la publicidad de Ethereum no es una opción atractiva, crear
      herramientas basadas en Ethereum para resistir la manipulación de votos sí lo es,
      lo que nos lleva a MACI.
    </p>
    ...
    <blockquote>
      ...
      <p>
        Cuando Alice emite su voto, firma su voto con su clave privada, cifra su firma con la
        clave pública de Dave y envía el resultado al contrato inteligente.
      </p>
    ...
    <p>
      Esta es una tecnología de vanguardia y viene con algunas limitaciones en este momento.
    </p>
    <ul>
      <li>
