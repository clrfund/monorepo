      ...
      <div class="form-area">
        <div class="application">
            ...
            <div class="inputs">
              ...
              <div class="form-background">
                ...
                <form class="radio-row" id="category-radio">
                  ...
                  />
                  <label for="tooling" class="radio-btn">{{
                    $t('join.step0.label5')
                  }}</label>
                  <input
                    id="category-content"
                  ...
                  />
                  <label for="research" class="radio-btn">
                    {{ $t('join.step0.label7') }}</label
                  >
                  ...
                  />
                  <label for="data" class="radio-btn">
                    {{ $t('join.step0.label8') }}</label
                  >
                </form>
                <p
                  :class="{
          ...
          <div v-if="currentStep === 3">
            ...
            <div class="inputs">
              <div class="form-background">
                <label for="links-github" class="input-label">{{
                  $t('join.step3.label1')
                }}</label>
                <input
                  id="links-github"
              ...
              <div class="form-background">
                <label for="links-radicle" class="input-label">{{
                  $t('join.step3.label2')
                }}</label>
                <input
                  id="links-radicle"
              ...
              <div class="form-background">
                <label for="links-website" class="input-label">{{
                  $t('join.step3.label3')
                }}</label>
                <input
                  id="links-website"
              ...
              <div class="form-background">
                <label for="links-twitter" class="input-label">{{
                  $t('join.step3.label4')
                }}</label>
                <input
                  id="links-twitter"
              ...
              <div class="form-background">
                <label for="links-discord" class="input-label">{{
                  $t('join.step3.label5')
                }}</label>
                <input
                  id="links-discord"
