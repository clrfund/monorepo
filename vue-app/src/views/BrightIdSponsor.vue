<template>
  <div>
    ...
    <p>
      You need a sponsorship token to become BrightID verified. This helps support BrightID as a decentralized platform.
      You’ll only ever need to do this once and it covers you for any other app that works with BrightID. Check the
      BrightID mobile app to see if you're sponsored. If you're not, click the button below to submit a sponsorship
      request.
    </p>
    <div class="transaction">
      <div>
        <div>
          <wallet-widget v-if="!currentUser" class="button" :is-action-button="true" :full-width-mobile="true" />
          <button
            v-else
            type="button"
