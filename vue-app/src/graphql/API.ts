  ...
  fundingRound: Maybe<{
    ...
    contributors: Maybe<
      Array<{
        __typename?: 'Contributor'
        contributions: Maybe<
          Array<{ __typename?: 'Contribution'; amount: Maybe<any> }>
        >
      }>
    >
  }>
...
export type GetRoundsQuery = {
  __typename?: 'Query'
  fundingRounds: Array<{ __typename?: 'FundingRound'; id: string }>
}
...
export function getSdk(
  ...
  return {
    GetContributionsAmount(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetContributionsAmountQuery>(
            GetContributionsAmountDocument,
            variables,
    ...
    GetTotalContributed(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetTotalContributedQuery>(
            GetTotalContributedDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'GetTotalContributed'
