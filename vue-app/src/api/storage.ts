...
function setItem(accountId: string, encryptionKey: string, storageKey: string, value: string): void {
...
async function getItem(accountId: string, encryptionKey: string, storageKey: string): Promise<string | null> {
	const fullStorageKey = getFullStorageKey(accountId, storageKey)
