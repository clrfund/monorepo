 ...
 * Sample usage:
 *
 *  yarn hardhat clr-load-merkle-users --address-file addresses.txt --user-registry <address> --network goerli
 */
...
task(
  'clr-load-merkle-users',
  'Bulkload recipients into the simple user registry'
)
