...
# save the MACI private key in the .env file for running the tally script later
echo '# Coordinator MACI key generated by deployLocal.sh script'
echo COORDINATOR_MACISK=${COORDINATOR_MACISK} >> ${CONTRACTS_DIRECTORY}/.env
