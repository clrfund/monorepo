<template>
	<div>
		...
		<p>
			BrightID verification helps prove that you’re a unique human. To get verified, you need enough people to
			confirm they've met you and you're a real person. There are a couple of ways to do this:
		</p>
		<accordion
			tag="🚀 Fastest"
